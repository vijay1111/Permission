...
public class DesignPermssion extends BaseActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    private static final String TAG = "DesignPermssion";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_design_permssion);
    ...
    public void view_click(View view) {
        switch (view.getId()) {
            ...
            case R.id.buttonUpdateContact:
                modifyCotact();
                break;
            case R.id.buttonPhotoTagActivity:
                startPhotoTagActivity();
                break;
            default:
                break;
        }
