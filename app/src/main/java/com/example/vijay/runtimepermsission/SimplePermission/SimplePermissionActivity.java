package com.example.vijay.runtimepermsission.SimplePermission;
...
public class SimplePermissionActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    private static final String TAG = "SimplePermissionActivity";
                ...
                Snackbar.make(findViewById(android.R.id.content),
                        ...
                        new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ActivityCompat.requestPermissions(SimplePermissionActivity.this, new String[]{Manifest.permission.WRITE_CONTACTS}, MY_PERMISSION_REQUEST_WRITE_CONTACTS);
                            }
                        }).show();
            } else {
            ...
            if (ActivityCompat.shouldShowRequestPermissionRationale(this, Manifest.permission.READ_CONTACTS)) {
                ...
                Snackbar.make(findViewById(android.R.id.content), "Need permission for loading data", Snackbar.LENGTH_INDEFINITE).setAction("ENABLE",
                        new View.OnClickListener() {
                            @Override
                            public void onClick(View v) {
                                ActivityCompat.requestPermissions(SimplePermissionActivity.this, new String[]{Manifest.permission.READ_CONTACTS}, MY_PERMISSIONS_REQUEST_READ_CONTACTS);
                            }
                        }).show();
            } else {
